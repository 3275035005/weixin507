<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="status" label="是否为商家">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.flag == 0" type="primary">否</el-tag>
          <el-tag v-if="scope.row.flag == 1" type="warning">是</el-tag>
        </template>
      </el-table-column>
    ...
    >
      <el-form :model="formData" label-position="left" label-width="100px">
        ...
        <el-form-item label="是否为商家">
          <el-select v-model="formData.flag" placeholder="请选择是否为商家">
